...
public class Logger {
    ...
    private static final String TAG = "IOTech";
    ...
    public static void logHeap(Class clazz) {
        ...
        Logger.i(TAG_MEMORY, memMessage);
        ...
        Logger.d(TAG_MEMORY, "debug. =================================");
        Logger.d(TAG_MEMORY, "debug.heap native: allocated " + df.format(allocated) + "MB of " + df.format(available) + "MB (" + df.format(free) + "MB free) in [" + clazz.getName().replaceAll("com.myapp.android.", "") + "]");
        Logger.d(TAG_MEMORY, "debug.memory: allocated: " + df.format((double) (Runtime.getRuntime().totalMemory() / 1048576)) + "MB of " + df.format((double) (Runtime.getRuntime().maxMemory() / 1048576)) + "MB (" + df.format((double) (Runtime.getRuntime().freeMemory() / 1048576)) + "MB free)");
    }
}
